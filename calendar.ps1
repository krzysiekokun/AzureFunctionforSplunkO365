...
foreach ($user in $users) {
    $userId = $user.id
    $eventsUri = "https://graph.microsoft.com/v1.0/users/$userId/calendar/calendarView?startDateTime=$($createdStartDate.ToString("2022-04-11T10:00:00-08:00"))&endDateTime=$($createdEndDate.ToString("2024-04-13T18:00:00-08:00"))"
